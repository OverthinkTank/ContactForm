...
function submitToAPI(e) {
  ...
  if(contact_form.reportValidity()) {
    ReactDOM.render( <span class="success label"> Submitting data... </span> ,document.querySelector('#span-message'));
...
return (
 <div style={{
    ...
    <form style={{ width: "50%" }} id="contact-form">
      ...
      <FormControl margin="normal" fullWidth>
        <TextField required id="email" type="email" label="Email" variant="outlined" onBlur = {event => validate()}/>
      </FormControl>

      <FormControl margin="normal" fullWidth>
        <TextField required id="message" type="message" label="Message" variant="outlined" multiline rows={10} onBlur = {event => validate()}/>
      </FormControl>
